...
What we do care about though is the *up_to_date?* function as it will be run each time we retrieve a batch. Since it's run while the user is waitin for stats to display, we want it to be as light as possible.
